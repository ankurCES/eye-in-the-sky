...
## Flying missions vs working on the code

To **fly a drone mission**, load the `godseye-uav` skill — `.claude/skills/godseye-uav/SKILL.md`
(a symlink to `.agents/skills/godseye-uav/`). It carries the mission patterns, sensor doctrine, safety
contract and SALUTE/INTREP templates, and its non-negotiable workflow is
